...
%               iv. 'fiscal+mp counterfactual'
	...
	par.plot_vars = {'bg','n','y','rho'};
    par.labels = {'govt debt','employment','GDP','spread'};        
    ...
    data_plot = {[data.bg,data_plus.bg],[data.n,data_plus.n],[data.y,data_plus.y],[data.rho,data_plus.rho]};
